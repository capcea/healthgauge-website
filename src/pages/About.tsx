...
const Component: React.FC = () => {
  return (
    <>
      <SEO title="About Codex" description="Learn how Codex builds fast calculators and actionable news for everyday health decisions." url="/about" />
      <section className="py-16">
        <div className="mx-auto max-w-4xl space-y-6 px-4">
          <h1 className="text-4xl font-bold text-slate-900 dark:text-white">About Codex</h1>
          <p className="text-lg text-slate-600 dark:text-slate-300">
            Codex is a small, research-driven team based in Bucharest and London. We build calculators and stories that help
          ...
          <div className="grid gap-6 md:grid-cols-2">
            ...
            <div className="card space-y-3">
              ...
              <p className="text-sm text-slate-600 dark:text-slate-300">
                Built with React, Vite, and TypeScript, Codex ships with Tailwind CSS, MDX content, Google Analytics, and Google
